...
#difercia de duracion 
diferencia_con_min = 100 - dalto_curso / otros_cursos_min * 100
diferencia_con_max = 100 - dalto_curso*1000 // otros_cursos_max / 10
diferencia_con_promedio = 100 - dalto_curso / otros_cursos_promedio * 100

#Calculando el porcentajede tiempo vacio removido
tiempo_vacio_promedio = 100 - otros_cursos_promedio * 1000 // crupo_promedio / 10
...
#Mostrando la cantidad de espacios vacios que se remueve
print(f'un curso promedio elimina un {tiempo_vacio_promedio}% de tiempo vacio')
print(f'el curso de dalto elimina un {tiempo_vacio_dalto}% el tiempo vacio')
print('-----------------------------------')
